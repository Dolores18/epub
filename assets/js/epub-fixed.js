/*
 * EPUB.js - Modified Version
 * =========================
 *
 * 这是一个修改过的EPUB.js版本，主要修复了以下问题：
 *
 * 1. Direction设置优先级问题：
 *    - 原版：metadata.direction强制覆盖用户设置
 *    - 修复：settings.direction > metadata.direction > defaultDirection
 *    - 位置：第8610行附近的初始化逻辑
 *
 * 2. Writing-Mode全局控制功能：
 *    - 新增：支持全局writingMode选项覆盖章节CSS样式
 ...
 *     width: "100%",
 *     height: "600px",
 *     direction: "ltr",           // 覆盖metadata的direction设置
 *     writingMode: "vertical-rl"  // 覆盖章节CSS的writing-mode
 *   });
 *
 * 2. 通过API动态设置：
 *   rendition.direction('ltr');        // 设置文字方向
 *   rendition.writingMode('vertical-rl'); // 设置书写模式
 *
 * 支持的writing-mode值：
 *   - "horizontal-tb" (默认，水平从上到下)
 *   - "vertical-rl"   (垂直从右到左，适合中日韩传统排版)
 *   - "vertical-lr"   (垂直从左到右)
 *
 * 支持的direction值：
 *   - "ltr" (从左到右，适合中英文等)
 *   - "rtl" (从右到左，适合阿拉伯语希伯来语等)
 *
 * 注意：这不是官方版本，请谨慎在生产环境使用
 *
 */
...
/* harmony default export */ var views = (Views);
      ...
      class default_DefaultViewManager {
        ...
        updateWritingMode(mode) {
          // 添加详细调试日志查看Manager.updateWritingMode
          console.log('=== Manager.updateWritingMode调用 ===');
          console.log('传入的mode参数:', mode);
          console.log('设置前 this.writingMode:', this.writingMode);

          this.writingMode = mode;

          console.log('设置后 this.writingMode:', this.writingMode);
          console.log('================================');
        }
        ...
        direction(dir = "ltr") {
          // 添加调试日志查看Manager.direction的调用
          console.log('=== Manager.direction调用 ===');
          console.log('传入的dir参数:', dir);
          console.log('设置前 this.settings.direction:', this.settings.direction);
          console.log('设置前 this.viewSettings.direction:', this.viewSettings.direction);

          this.settings.direction = dir;
          this.stage && this.stage.direction(dir);
          this.viewSettings.direction = dir;

          console.log('设置后 this.settings.direction:', this.settings.direction);
          console.log('设置后 this.viewSettings.direction:', this.viewSettings.direction);
          console.log('===========================');
        ...
        /**
         * Set the writing-mode of the manager
         * @param  {string} mode "horizontal-tb" | "vertical-rl" | "vertical-lr"
         */
        writingMode(mode = "horizontal-tb") {
          // 添加调试日志查看Manager.writingMode的调用
          console.log('=== Manager.writingMode调用 ===');
          console.log('传入的mode参数:', mode);
          console.log('设置前 this.settings.writingMode:', this.settings.writingMode);
          console.log('设置前 this.viewSettings.writingMode:', this.viewSettings.writingMode);

          this.settings.writingMode = mode;
          this.viewSettings.writingMode = mode;

          console.log('设置后 this.settings.writingMode:', this.settings.writingMode);
          console.log('设置后 this.viewSettings.writingMode:', this.viewSettings.writingMode);
          console.log('===============================');
...
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1);
      ...
      class Contents {
        ...
        columns(width, height, columnWidth, gap, dir) {
          // 添加调试日志查看columns函数的参数和逻辑
          console.log('=== contents.columns函数调用 ===');
          console.log('传入的dir参数:', dir);
          ...
          console.log('判断条件: dir === "rtl":', dir === "rtl");
          console.log('判断条件: axis === "horizontal":', axis === "horizontal");

          this.layoutStyle("paginated");

          if (dir === "rtl" && axis === "horizontal") {
            console.log('✅ 满足条件，将调用this.direction("' + dir + '")');
            this.direction(dir);
          } else {
            console.log('❌ 不满足条件，不修改direction');
          }
          console.log('===========================');
        ...
        writingMode(mode, globalWritingMode) {
          let WRITING_MODE = Object(_utils_core__WEBPACK_IMPORTED_MODULE_1__["prefixed"])("writing-mode");

          // 添加调试日志查看writingMode的覆盖逻辑
          console.log('=== Contents.writingMode调用 ===');
          console.log('传入的mode参数:', mode);
          console.log('传入的globalWritingMode:', globalWritingMode);

          // 如果有全局writingMode设置，优先使用全局设置
          let finalMode = globalWritingMode || mode;
          ...
          const computedDirection = this.window.getComputedStyle(this.documentElement)['direction'] || 'ltr';

          console.log('=== 章节CSS样式信息 ===');
          console.log('writing-mode:', computedWritingMode);
          console.log('direction:', computedDirection);
          console.log('最终使用的writing-mode:', computedWritingMode);
          console.log('====================');

          return computedWritingMode;
        }
        /**
...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
      ...
      class layout_Layout {
        constructor(settings) {
          // 添加调试日志查看Layout构造函数接收的settings
          console.log('=== Layout构造函数 ===');
          console.log('settings.direction:', settings.direction);
          console.log('settings完整对象:', settings);
          console.log('======================');
        ...
        format(contents, section, axis) {
          ...
          if (this.name === "pre-paginated") {
            ...
            // 添加调试日志查看layout.format传给columns的direction参数
            console.log('=== layout.format调用columns ===');
            console.log('this.settings.direction:', this.settings.direction);
            console.log('================================');
      ...
      class rendition_Rendition {
        constructor(book, options) {
          this.settings = Object(core["extend"])(this.settings || {}, {
            ...
            writingMode: null,  // 添加writingMode选项，用于覆盖章节CSS
            allowScriptedContent: false,
            allowPopups: false
          });
          Object(core["extend"])(this.settings, options);
        ...
        start() {
          ...
          // 添加调试日志查看metadata.direction的值
          console.log('=== 初始化direction调试 ===');
          console.log('metadata.direction:', this.book.package.metadata.direction);
          console.log('settings.defaultDirection:', this.settings.defaultDirection);
          console.log('最终使用的direction:', this.book.package.metadata.direction || this.settings.defaultDirection);
          console.log('========================');

          // 修复：使用与determineLayoutProperties相同的优先级逻辑
          // 优先级：settings.direction > metadata.direction > defaultDirection
          var initialDirection = this.settings.direction || this.book.package.metadata.direction || this.settings.defaultDirection;
          console.log('=== 修复后的direction逻辑 ===');
          console.log('settings.direction:', this.settings.direction);
          console.log('metadata.direction:', this.book.package.metadata.direction);
          console.log('defaultDirection:', this.settings.defaultDirection);
          console.log('最终选择的direction:', initialDirection);
          console.log('============================');
          this.direction(initialDirection); // Parse metadata to get layout props

          // 添加writingMode初始化逻辑
          if (this.settings.writingMode) {
            console.log('=== 初始化writingMode ===');
            console.log('用户设置的writingMode:', this.settings.writingMode);
        ...
        */
        ...
        determineLayoutProperties(metadata) {
          ...
          console.log('=== Direction设置信息 ===');
          console.log('settings.direction:', this.settings.direction);
          console.log('metadata.direction:', metadata.direction);
          console.log('最终direction:', direction);
          console.log('====================');
        ...
        direction(dir) {
          // 添加调试日志查看Rendition.direction的调用
          console.log('=== Rendition.direction调用 ===');
          console.log('传入的dir参数:', dir);
          console.log('设置前 this.settings.direction:', this.settings.direction);
        ...
        /**
         * Adjust the writing-mode of the rendition
         * @param  {string} mode "horizontal-tb" | "vertical-rl" | "vertical-lr"
         */
        writingMode(mode) {
          // 添加调试日志查看Rendition.writingMode的调用
          console.log('=== Rendition.writingMode调用 ===');
          console.log('传入的mode参数:', mode);
          console.log('设置前 this.settings.writingMode:', this.settings.writingMode);

          this.settings.writingMode = mode || "horizontal-tb";

          console.log('设置后 this.settings.writingMode:', this.settings.writingMode);
          console.log('===============================');

          if (this.manager) {
            this.manager.writingMode(this.settings.writingMode);
          }
...
/* harmony import */ var marks_pane__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(marks_pane__WEBPACK_IMPORTED_MODULE_5__);
      ...
      class IframeView {
        constructor(section, options) {
          ...
          // 添加调试日志查看IframeView构造函数接收的settings
          console.log('=== IframeView构造函数 ===');
          console.log('options.writingMode:', options ? options.writingMode : 'undefined');
          console.log('this.settings.writingMode:', this.settings.writingMode);
          console.log('============================');
        ...
        render(request, show) {
          ...
          return this.sectionRender.then(function (contents) {
            ...
            // 添加调试日志查看writingMode的获取
            console.log('=== IframeView.render - 获取writingMode ===');
            console.log('全局writingMode设置:', this.settings.writingMode);
            // 传递全局writingMode设置给Contents.writingMode()
            let writingMode = this.contents.writingMode(null, this.settings.writingMode); // Set the axis based on the flow and writing mode
            console.log('从章节CSS获取的writingMode:', writingMode);
            console.log('=======================================');
            ...
            // 添加调试日志查看setWritingMode调用
            console.log('=== IframeView.setWritingMode调用 ===');
            console.log('设置的writingMode:', writingMode);
            this.setWritingMode(writingMode);
            console.log('=== 发送WRITING_MODE事件 ===');
